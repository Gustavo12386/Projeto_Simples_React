export function Navegacao(props){
    return <div className="navegacao">
      ...
      <input type="radio" name="opcao-pagina" id="pagina-1" defaultChecked onClick={() => props.atualizarPaginaSelecionada(1)}/>
      <label htmlFor="pagina-1">Sobremesas</label>
      <input type="radio" name="opcao-pagina" id="pagina-2" defaultChecked onClick={() => props.atualizarPaginaSelecionada(2)}/>
